...
export function SharkThoughts({
  isVisible,
  personality,
  recentAction = "hunting",
  gameContext,
}: SharkThoughtsProps) {
  ...
  return (
    <AnimatePresence>
      {isVisible && thoughts && (
        ...
        >
          <div
            className={`rounded-lg border-2 p-4 shadow-2xl backdrop-blur-sm ${getPersonalityStyle()}`}
          >
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                <h3 className="text-sm font-bold mb-1 opacity-80">Shark's Inner Monologue</h3>
