...
// TouchActionButtons now in GameHUD
import { GameHUD } from "./GameHUD"
// Minimap now in GameHUD
...
export function GameCanvas() {
  ...
  return (
    <div className="relative w-full h-screen">
      ...
      {/* (Minimap, AI badge, touch actions, NPC prompt are now in GameHUD) */}
      ...
      {/* HUD — player stats, minimap, controls, AI badge, touch actions, NPC prompt */}
      <GameHUD
        ...
        playerFishInventory={playerFishInventory}
        orangeBuffActive={orangeBuffActive}
        orangeBuffTimeLeft={orangeBuffTimeLeft}
        heldItem={heldBeachItemRef.current}
        canPickupItem={canPickupItem}
        minimapVisible={minimapVisible}
        setMinimapVisible={setMinimapVisible}
        harpoonStations={harpoonStationsRef.current}
