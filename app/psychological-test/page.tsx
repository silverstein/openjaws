...
import type { SharkPersonality, Taunt } from "@/lib/types/shark"
  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white p-8">
      ...
      <div className="space-y-6">
        ...
        <div className="bg-gray-800 p-6 rounded-lg">
          ...
          <div className="space-y-4">
            ...
            <div>
              <label htmlFor="shark-personality" className="block text-sm font-medium mb-2">
                Shark Personality
              </label>
              <select
                ...
                onChange={(e) =>
                  setTestState((prev) => ({
                    ...prev,
                    sharkPersonality: e.target.value as SharkPersonality,
                  }))
                }
      ...
      <PersonalizedTaunts
        ...
        playerPosition={{
          x: typeof window !== "undefined" ? window.innerWidth / 2 : 400,
          y: typeof window !== "undefined" ? window.innerHeight - 300 : 300,
        }}
        personality={testState.sharkPersonality}
      ...
      <RecognitionMoment
        ...
        memories={[
          {
            encounter: "First blood in the shallows",
            outcome: "You barely escaped",
            timestamp: "3 games ago",
          },
          {
            encounter: "The rock hiding trick",
            outcome: "I learned your pattern",
            timestamp: "2 games ago",
          },
          {
            encounter: "Speed boost to the left",
            outcome: "Predictable as always",
            timestamp: "Last game",
          },
        ]}
