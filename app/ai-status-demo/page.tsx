...
import { AIStatusIndicator, AIStatusBadge } from '@/components/ui/AIStatusIndicator';
        ...
        <div className="space-y-8">
          ...
          <section className="bg-black/20 backdrop-blur-sm rounded-lg p-6 border border-white/10">
            ...
            <p className="text-white/70 mb-6">
              This component shows the current AI mode and remaining API calls.
              Click on it to see detailed statistics.
            </p>
          ...
          <section className="bg-black/20 backdrop-blur-sm rounded-lg p-6 border border-white/10">
            ...
            <p className="text-white/70 mb-6">
              This minimal badge appears in-game when using mock or cached AI.
              It stays hidden during real AI mode to avoid distraction.
            </p>
          ...
          <section className="bg-black/20 backdrop-blur-sm rounded-lg p-6 border border-white/10">
            ...
            <div className="grid grid-cols-3 gap-4">
              ...
              <TestButton 
                ...
                payload={{ action: 'greeting', context: '{"npcType":"surfer","npcName":"Kai","playerName":"Player","timeOfDay":"day"}' }}
              />
              <TestButton 
                label="Test Commentary" 
                endpoint="/api/commentary"
                payload={{ context: { event: 'shark spotted', players: ['Player1'], sharkHealth: 100, intensity: 'building', style: 'documentary' } }}
              />
            </div>
          </section>
          ...
          <section className="bg-black/20 backdrop-blur-sm rounded-lg p-6 border border-white/10">
            ...
            <div className="space-y-4 text-white/70">
              <p>
                The mock AI system provides intelligent responses without using API calls:
              </p>
              ...
              <p>
                Players should experience minimal difference between real and mock AI,
                ensuring a consistent gameplay experience even in free tier mode.
              </p>
            </div>
          </section>
        </div>
...
function TestButton({ label, endpoint, payload }: { label: string; endpoint: string; payload: any }) {
    ...
    <div>
      ...
      {response && (
        <div className="mt-2 text-xs text-white/60">
          Mode: {response.mode || 'N/A'}<br />
          Calls left: {response.remaining || 'N/A'}
        </div>
      )}
    </div>
  );
