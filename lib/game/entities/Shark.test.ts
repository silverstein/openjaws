...
import { Shark, SharkState, AIDecision } from './Shark'
...
describe('Shark Entity', () => {
  ...
  describe('Initialization', () => {
    ...
    it('should start in patrol state', () => {
      expect(shark.container.children[1].text).toBe('Patrolling')
    })
  ...
  describe('State Machine', () => {
    it('should transition from patrol to hunting when player is detected', () => {
      ...
      expect(shark.container.children[1].text).toBe('Hunting!')
    })
    ...
    it('should transition from hunting to attacking when close', () => {
      ...
      expect(shark.container.children[1].text).toBe('ATTACK!')
    })
  ...
  describe('Stun Mechanics', () => {
    it('should enter stunned state', () => {
      ...
      expect(shark.container.children[1].text).toBe('Stunned')
    })
  ...
  describe('Personality System', () => {
    ...
    it('should update AI thought when setting personality', () => {
      const thoughtText = shark.container.children[2] as any
  ...
  describe('Edge Cases', () => {
    ...
    it('should continue functioning when stunned regardless of AI', () => {
      ...
      // Should not poll AI when stunned
      vi.useFakeTimers()
      vi.advanceTimersByTime(3000)
      
      shark.update(16, player)
      
      expect(mockController.getDecision).not.toHaveBeenCalled()
