...
import { GameContext, SharkPersonality } from './sharkBrain'
...
describe('Mock AI Response System', () => {
  ...
  describe('generateMockSharkDecision', () => {
    ...
    it('should respect personality types', () => {
      const personalities: SharkPersonality[] = ['methodical', 'theatrical', 'vengeful', 'philosophical', 'meta']
  ...
  describe('generateMockCommentary', () => {
    it('should generate commentary for all styles', () => {
      const styles = Object.keys(commentaryMockResponses) as Array<keyof typeof commentaryMockResponses>
